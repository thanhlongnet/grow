return {
    ...
    BUY_EGGS = { "Bug Egg", "Bee Egg", "Paradise Egg", "Mythical Egg", "Rare Summer Egg", "Common Summer Egg",  "Common Egg",
		-- "Legendary Egg",
		"Rare Egg", "Uncommon Egg"},
    PLANT_EGGS = { "Anti Bee Egg", "Rare Egg", "Common Summer Egg", "Enchanted Egg", "Sprout Egg", "Gourmet Egg", "Corrupted Zen Egg", "Zen Egg", "Dinosaur Egg", "Primal Egg", "Night Egg", "Bug Egg", "Paradise Egg", "Uncommon Egg", "Common Egg"
		 -- "Legendary Egg",
	},
    ...
    KEEP_PETS = { "Phoenix", "Drake", ["Wisp"] = 5, "Luminous Sprite", "Cockatrice", "Gnome", "Griffin", "Apple Gazelle", "Green Bean", "Lemon Lion", "Golden Goose", "Kitsune", "Corrupted Kitsune", "French Fry Ferret", "Lobster Thermidor",
					 ...
					 ["Peacock"] = 3, ["Ostrich"] = 4, ["Turtle"] = 3, ["Sea Turtle"] = 3, ["Scarlet Macaw"] = 3, ["Sunny-Side Chicken"] = 3, ["Golden Lab"] = 15, ["Chicken"] = 3},
    KEEP_PETS_WEIGHT = 6,
    KEEP_PETS_AGE = 90,
	EQUIP_PETS = { ["Wasp"] = 2, ["Tarantula Hawk"] = 2, ["Golden Lab"] = 6, ["Chicken"] = 3, ["Starfish"] = 2, ["Luminous Sprite"] = 1, ["Capybara"] = 1, ["Rooster"] = 4},
    --EQUIP_PETS = { ["Rooster"] = 8, ["Starfish"] = 2, ["Tarantula Hawk"] = 1, ["Wasp"] = 1, ["Luminous Sprite"] = 8 },
    USE_PETS_FOR_UPGRADE_SLOT = { "Golden Lab" },
    REMOVE_PET_MAX_UPGRADE = { "Golden Lab" },  -- Unequip from garden
