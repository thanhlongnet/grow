return {
    ...
    PLANT_EGGS = { "Anti Bee Egg", "Rare Egg", "Common Summer Egg", "Enchanted Egg", "Sprout Egg", "Gourmet Egg", "Corrupted Zen Egg", "Zen Egg", "Dinosaur Egg", "Primal Egg", "Night Egg", "Bug Egg", "Paradise Egg", "Uncommon Egg"
		 -- "Legendary Egg",
	},
    ...
    KEEP_PETS = { "Phoenix", "Drake", ["Wisp"] = 5, "Luminous Sprite", "Cockatrice", "Gnome", "Griffin", "Apple Gazelle", "Green Bean", "Lemon Lion", "Golden Goose", "Kitsune", "Corrupted Kitsune", "French Fry Ferret", "Lobster Thermidor",
					 ...
					 ["Peacock"] = 3, ["Ostrich"] = 4, ["Turtle"] = 3, ["Sea Turtle"] = 3, ["Scarlet Macaw"] = 3, ["Sunny-Side Chicken"] = 3, "Golden Lab" = 8},
    KEEP_PETS_WEIGHT = 6,
    KEEP_PETS_AGE = 90,
