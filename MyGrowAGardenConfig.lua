return {
    ...
    ["Destroy Mode"] = {
        ...
        ["Trees"] = {"Strawberry", "Blueberry", "Corn", "Orange Tulip", "Carrot", "Tomato", "Daffodil", "Watermelon", "Pumpkin", "Apple", "Bamboo", "Coconut", "Cactus", "Dragon Fruit", "Mango", "Wild Carrot", "Kiwi", "Pineapple"},
