return {
    ...
    BUY_EVENT_SHOP = { "Fall Egg", "Space Squirrel", ["Red Squirrel"] = 5, ["Chipmunk"] = 5},
    ...
    KEEP_PETS = { "Barn Owl", "Swan", "Marmot", ["Badger"] = 5, ["Grizzly Bear"] = 5, ["Red Squirrel"] = 5, ["Chipmunk"] = 5, "Space Squirrel", "Sugar Glider", "Phoenix", "Drake", ["Wisp"] = 5, "Luminous Sprite", "Cockatrice", ["Glimmering Sprite"] = 3, ["Shroomie"] = 5, "Gnome", "Griffin", "Apple Gazelle", "Green Bean", "Lemon Lion", "Golden Goose", "Kitsune", "Corrupted Kitsune", "French Fry Ferret", "Lobster Thermidor",
