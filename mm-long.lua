return {
    ...
    BUY_EGGS = { "Bug Egg", "Bee Egg", "Paradise Egg", "Mythical Egg", "Rare Summer Egg", "Common Summer Egg",
        -- "Legendary Egg",
        "Rare Egg"},
    PLANT_EGGS = { "Jungle Egg", "Rare Egg", "Fall Egg",
         -- "Anti Bee Egg", "Bug Egg", "Legendary Egg",  "Common Summer Egg",  "Enchanted Egg", "Sprout Egg", "Gourmet Egg", "Corrupted Zen Egg", "Zen Egg", "Dinosaur Egg", "Primal Egg", "Night Egg", "Paradise Egg",
    },
    ...
    KEEP_PETS = { "Tiger", "Chimpanzee", "Red Panda", "Barn Owl", "Swan", ["Marmot"] =5, "Space Squirrel", "Sugar Glider", "Phoenix", "Drake", ["Wisp"] = 5, "Luminous Sprite", "Cockatrice", ["Glimmering Sprite"] = 3, "Gnome", "Griffin", "Apple Gazelle", "Green Bean", "Lemon Lion", "Golden Goose", "Kitsune", "Corrupted Kitsune", "French Fry Ferret", "Lobster Thermidor",
    ...
    KEEP_PETS_WEIGHT = 6,
    KEEP_PETS_AGE = 90,
    EQUIP_PETS = { ["Wasp"] = 8, ["Tarantula Hawk"] = 8,},
