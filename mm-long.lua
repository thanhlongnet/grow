return {
    ...
    KEEP_PETS = { ["Iguana"] = 5,["Hummingbird"] = 5, ["Tree Frog"] =5, "Tiger", ["Chimpanzee"] = 5, "Red Panda", "Barn Owl", "Swan", "Phoenix", "Drake", ["Wisp"] = 5, "Luminous Sprite", "Cockatrice", "Gnome", "Griffin", "Apple Gazelle", "Green Bean", "Lemon Lion", "Golden Goose", "Kitsune", "Corrupted Kitsune", "French Fry Ferret", "Lobster Thermidor",
