return {
    ...
    KEEP_PETS = { "Firefly", "Sliver Dragonfly", ["Iguana"] = 5,["Hummingbird"] = 5, ["Tree Frog"] =5, "Tiger", ["Chimpanzee"] = 5, ["Blue Jay"] = 5, "Red Panda", "Barn Owl", "Swan", "Space Squirrel", "Phoenix", ["Wisp"] = 5,
