return {
    ...
    KEEP_PETS = { "Fortune Squirrel", "Chubby Chipmunk", "Chinchilla", "Firefly", "Silver Dragonfly", ["Hummingbird"] = 3, "Tiger", ["Chimpanzee"] = 3, "Blue Jay", "Red Panda", ["Space Squirrel"] = 1, ["Barn Owl"] = 1, "Swan", "Phoenix", ["Wisp"] = 5,
