return {
    ...
    KEEP_PETS = { "Blue Jay", ["Iguana"] = 8, "Tiger", "Chimpanzee", "Red Panda", "Barn Owl", "Swan", "Space Squirrel", "Sugar Glider", "Phoenix", ["Wisp"] = 5,
        "Luminous Sprite", "Cockatrice", ["Glimmering Sprite"] = 3, "Gnome", "Griffin", "Apple Gazelle",
