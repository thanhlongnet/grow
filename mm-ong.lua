return {
    ...
    PLANT_EGGS = { "Jungle Egg", "Anti Bee Egg", "Rare Egg",},
         --  "Bug Egg", "Legendary Egg",  "Common Summer Egg",  "Enchanted Egg", "Sprout Egg", "Gourmet Egg", "Corrupted Zen Egg", "Zen Egg", "Dinosaur Egg", "Primal Egg", "Night Egg", "Paradise Egg",
